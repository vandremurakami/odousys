...
import com.vandremurakami.odousys.controle.ControleListaDentista;
 ...
 * @author Vandre
 */
public class panelListarDentista extends javax.swing.JPanel {
    
    final private ControleListaDentista controleListaDentista;

    /**
     * Creates new form painelListarDentista
     */
    public panelListarDentista() {
        initComponents();
        controleListaDentista = new ControleListaDentista(this);
    }
    
    public JTable getTabelaDentista() {
    ...
    private void initComponents() {
        ...
        scrollPaneTabelaDentista = new javax.swing.JScrollPane();
        tableDentista = new javax.swing.JTable();
        ...
        scrollPaneTabelaDentista.setMaximumSize(new java.awt.Dimension(1085, 410));
        scrollPaneTabelaDentista.setMinimumSize(new java.awt.Dimension(1085, 410));
        scrollPaneTabelaDentista.setPreferredSize(new java.awt.Dimension(1085, 410));

        tableDentista.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tableDentista.setMaximumSize(null);
        tableDentista.setMinimumSize(null);
        tableDentista.setPreferredSize(null);
        tableDentista.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        tableDentista.getColumnModel().getColumn(0).setPreferredWidth(200);
        tableDentista.getColumnModel().getColumn(1).setPreferredWidth(200);
        tableDentista.getColumnModel().getColumn(2).setPreferredWidth(50);
        tableDentista.getColumnModel().getColumn(3).setPreferredWidth(50);
        tableDentista.getColumnModel().getColumn(4).setPreferredWidth(50);
        tableDentista.getColumnModel().getColumn(5).setPreferredWidth(150);
        tableDentista.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tableDentistaMouseClicked(evt);
            }
        });
        scrollPaneTabelaDentista.setViewportView(tableDentista);

        add(scrollPaneTabelaDentista, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 110, 1085, 410));
    ...
    private void tableDentistaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableDentistaMouseClicked
        if (evt.getClickCount() == 2) {
            if(controleListaDentista != null)
                controleListaDentista.CadastroAbrirDentista();
        }
    }//GEN-LAST:event_tableDentistaMouseClicked

    private void labelAdicionarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_labelAdicionarMouseClicked
        if(controleListaDentista != null)
            controleListaDentista.CadastroAdicionarDentista();
    ...
    private void labelRemoverMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_labelRemoverMouseClicked
        if(controleListaDentista != null)
            controleListaDentista.RemoveDentista();
    ...
    private void labelFecharMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_labelFecharMouseClicked
        if(controleListaDentista != null)
            controleListaDentista.FecharListaDentista();
    ...
    private void labelLimparFiltroMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_labelLimparFiltroMouseClicked
        ...
        if(controleListaDentista != null)
            controleListaDentista.PreencheTabelaDentista();
    ...
    private javax.swing.JScrollPane scrollPaneTabelaDentista;
    private javax.swing.JTable tableDentista;
