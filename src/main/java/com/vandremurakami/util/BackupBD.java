...
public class BackupBD {
    ...
    public void executeCommand(String host, String databaseName, String databaseUser, String databasePassword, String type) {

        File backupFilePath = new File(ConfigXML.getCaminhoBackupBD());
        ...
        List<String> commands = getPgComands(host, databaseName, databaseUser, backupFilePath, backupFileName, type);
        if (!commands.isEmpty()) {
            try {
    ...
    private List<String> getPgComands(String host, String databaseName, String databaseUser, File backupFilePath, String backupFileName, String type) {
